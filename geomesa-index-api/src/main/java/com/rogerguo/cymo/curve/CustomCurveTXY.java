 ...
 */
@Deprecated
public class CustomCurveTXY implements SpaceFillingCurve {
    ...
    public CustomCurveTXY(int bitNumberX, int bitNumberY, int bitNumberT) {
    ...
    public long getCurveValue(int x, int y, int z) {
        ...
        return generateCurveEfficiently(z, x, y, bitNumberX, bitNumberY, bitNumberT);
    }
