 ...
 */
@Deprecated
public class CustomCurveXYTXYT implements SpaceFillingCurve {
    ...
    public CustomCurveXYTXYT(int bitNumberX, int bitNumberY, int bitNumberT, int bitNumberGroupX, int bitNumberGroupY, int bitNumberGroupT) {
    ...
    public static Map<String, Integer> from3DCurveEfficiently(long value, int bitNumberX, int bitNumberY, int bitNumberT, int bitNumberGroupX, int bitNumberGroupY, int bitNumberGroupT) {
        ...
        tempT = (value & BIT_MASK_MAP.get(bitNumberGroupT)) | (((value >> (bitGroupSize)) & BIT_MASK_MAP.get(bitNumberT)) << bitNumberGroupT) | (((value >> (totalBitSize)) & BIT_MASK_MAP.get(remainBitNumberT)) << (bitNumberGroupT + bitNumberT));
        tempY = ((value >> bitNumberGroupT) & BIT_MASK_MAP.get(bitNumberGroupY)) | (((value >> (bitGroupSize + bitNumberT)) & BIT_MASK_MAP.get(bitNumberY)) << bitNumberGroupY) | (((value >> (totalBitSize + remainBitNumberT)) & BIT_MASK_MAP.get(remainBitNumberY)) << (bitNumberGroupY + bitNumberY));
        tempX = ((value >> (bitNumberGroupT + bitNumberGroupY)) & BIT_MASK_MAP.get(bitNumberGroupX)) | (((value >> (bitGroupSize + bitNumberT + bitNumberY)) & BIT_MASK_MAP.get(bitNumberX)) << bitNumberGroupX) | (((value >> (totalBitSize + remainBitNumberT + remainBitNumberY)) & BIT_MASK_MAP.get(remainBitNumberX)) << (bitNumberGroupX + bitNumberX));
